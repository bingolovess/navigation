...
public class LazyFragment extends BaseFragment {
     ...
     * @return
     */
    protected static LazyFragment get() {
        return get(null);
    }
     ...
     * @return
     */
    protected static LazyFragment get(Object obj) {
    ...
    protected void onCreateView(Bundle savedInstanceState) {
        ...
        if (isLazyLoad) {
            if (isVisibleToUser && !isInit) {
                ...
                mPreviewLayout = new FrameLayout(layoutInflater.getContext());
                View view = getPreviewLayout(layoutInflater, mPreviewLayout);
                if (view != null) {
                    mPreviewLayout.addView(view);
                }
                mPreviewLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
                super.setContentView(mPreviewLayout);
            }
        } else {
            isInit = true;
            onCreateViewLazy(savedInstanceState);
    ...
    public void setContentView(int layoutResID) {
        if (isLazyLoad && getContentView() != null && getContentView().getParent() != null) {
            ...
            View view = inflater.inflate(layoutResID, mPreviewLayout, false);
            mPreviewLayout.addView(view);
        } else {
